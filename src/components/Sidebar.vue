        ...
        <div class="sidebar-sticky">
            ...
            <ul class="nav flex-column mb-2">
                ...
                <li class="nav-item" @click.prevent="btnStatus='/admin/order-list'">
                    <router-link class="nav-link" :class="{'active': btnStatus==='/admin/order-list'}"
                    to="/admin/order-list">
            ...
            <ul class="nav flex-column mb-2" @click.prevent="btnStatus='/user/customer-order'">
                <li class="nav-item">
                    <router-link class="nav-link" :class="{'active': btnStatus==='/user/customer-order'}"
                     to="/user-simulation/customer-order">

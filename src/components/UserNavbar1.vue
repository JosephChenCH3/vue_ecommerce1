    ...
    <div>
        <nav class="navbar navbar-expand-lg navbar-light navbar-scroll fixed-top shadow-sm">
            <div class="container">
                ...
                <div class="input-group hideobj-md showobj" style="width: auto;">
                    <input type="search" class="form-control-sm input-width d-inline" placeholder="Search" aria-label="Search" v-model="searchValue" @keyup.enter="searchProduct" style="position: relative; top: 1px;">
                    <div class="input-group-append  d-inline" >
                        ...
                        <button type="button" class="btn btn-sm btn-outline-secondary" style="width: 36px;" 
                             v-if="searchStatus == 'orderno'" @click="searchProduct">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-search-menu">
                            ...
                            <a class="dropdown-item dropdown-search-item" href="#" @click.prevent="searchStatus='orderno'">搜尋訂單</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="input-group hideobj" style="width: auto;">
                    <input type="search" class="form-control-sm input-width" placeholder="Search" aria-label="Search" v-model="searchValue" @keyup.enter="searchProduct">
    ...
    methods: {
        ...
        searchProduct() {
            ...
            if (this.searchStatus=== "product") {
                // this.$bus.$emit('getNavCategory', str);
                // this.$router.push(`/`);
                this.$router.push(`/search/${str}`);
                this.searchValue = "";
            } else if (this.searchStatus=== "orderno") {
                this.$router.push(`/order-check/${str}`);
                this.searchValue = "";
            }
